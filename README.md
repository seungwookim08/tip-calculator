...
![alt text](https://github.com/seungwookim08/tip-calculator/blob/master/Web%20Programming/img/screenshot1.PNG)
<br>Frontpage screentshot. Province can be chosen by dropdown list and price can be used. <br><br>
![alt text](https://github.com/seungwookim08/tip-calculator/blob/master/Web%20Programming/img/screenshot2.PNG)
<br>Enter the inputs. Currently, the tip rate is calculated as 15% (Original price + tax and then calculate tip). <br><br>
![alt text](https://github.com/seungwookim08/tip-calculator/blob/master/Web%20Programming/img/screenshot3.PNG)
<br>Output<br><br>
![alt text](https://github.com/seungwookim08/tip-calculator/blob/master/Web%20Programming/img/screenshot4.PNG)
<br>Wrong input (not a number) will result error message<br><br>
![alt text](https://github.com/seungwookim08/tip-calculator/blob/master/Web%20Programming/img/screenshot5.PNG)
